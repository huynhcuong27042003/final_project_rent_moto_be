...
class AppUserService {
    ...
    async updateUser(email, updatedFields) {
        ...
        const userData = await this.getUserByEmail(email); // Sử dụng getUserByEmail thay vì getUser bằng ID

        // Kiểm tra giá trị mới trong updatedFields và gán lại giá trị cũ nếu không có
        const updatedUser = new AppUser(
            ...
            updatedFields.information ? new Information(
            ...
            ) : userData.information, // Cập nhật thông tin nếu có
