...
const getMotorcycleByAdmin = require('../controllers/MotorcycleController/getMotorcycleByAdmin'); // Adjust path as necessary

// Define routes for CRUD operations on Motorcycle
router.post('/', addMotorcycle.addMotorcycle); // Create a new motorcycle
router.get('/allMotos/:id?', getMotorcycleByAdmin.getMotorcycleByAdmin); // Update a motorcycle by ID (PATCH method)
