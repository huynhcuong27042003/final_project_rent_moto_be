...
class BookingMoto {
    constructor(email, numberPlate, bookingDate, returnDate, numberOfRentalDay, isAccept, isHide, totalAmount, motorbikeRentalDeposit) {
        ...
        if (typeof motorbikeRentalDeposit !== 'number' || motorbikeRentalDeposit < 0) {
            throw new TypeError("motorbikeRentalDeposit must be a non-negative number.");
        }
        ...
        this._motorbikeRentalDeposit = motorbikeRentalDeposit;
    ...
    toObject() {
        return {
            ...
            motorbikeRentalDeposit: this._motorbikeRentalDeposit,
