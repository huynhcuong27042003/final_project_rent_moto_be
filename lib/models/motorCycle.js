...
class Motorcycle {
  constructor(numberPlate, companyMoto, category, informationMoto, isActive, isHide, email, address) {
    ...
    this.setEmail(email);
    this.setAddress(address);  // Add address to the constructor
  }
  ...
  setEmail(email) {
   ...
   // New setter for address validation
   setAddress(address) {
  ...
  toObject() {
    return {
        ...
        isHide: this._isHide,
        email: this._email,
        address: this._address.toObject() // Include email in the object representation
